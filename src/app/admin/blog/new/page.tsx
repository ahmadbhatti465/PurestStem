...
export default function NewBlogPostPage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">New Blog Post</h1>
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded-lg border">
        ...
        <div>
          ...
          <input name="author" defaultValue="PurestStem" className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm" />
        </div>
        ...
        <button type="submit" disabled={loading} className="bg-green-700 text-white px-6 py-2 rounded-md disabled:opacity-50">
